...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { address: @hospital.address, city: @hospital.city, hospital_id: @hospital.hospital_id, hospital_name: @hospital.hospital_name, hospital_type: @hospital.hospital_type, state: @hospital.state, telephone: @hospital.telephone } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { address: @hospital.address, city: @hospital.city, hospital_id: @hospital.hospital_id, hospital_name: @hospital.hospital_name, hospital_type: @hospital.hospital_type, state: @hospital.state, telephone: @hospital.telephone } }
