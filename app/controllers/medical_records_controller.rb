class MedicalRecordsController < ApplicationController
  ...
  private
    ...
    def medical_record_params
      params.require(:medical_record).permit(:ssn, :first_name, :middle_name, :last_name, :dob, :family_history, :address, :city, :state, :existing_cond, :allergies, :medications, :hcp_id, :telephone, :doctor_first_name, :doctor_last_name, :employee_id, :fasting)
    end
end
